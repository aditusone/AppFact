...
class AdminCmsUsersController extends CBController {
	...
	public function cbInit() {
		...
		$this->form[] = array("label"=>"Contraseña","name"=>"password","type"=>"password","help"=>"Por favor deje vacío si no cambia");
		$this->form[] = array("label"=>"Confirmaciíon de contraseña","name"=>"password_confirmation","type"=>"password","help"=>"Por favor deje vacío si no cambia");
